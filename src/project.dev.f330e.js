  ...
  CubeBg: [ function(require, module, exports) {
    ...
    var CubeBg = function(_super) {
      ...
      CubeBg.prototype.onKill = function(delay) {
        ...
        this.isPlaySpecial && (this.isPlaySpecial = false);
        setTimeout(function() {
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.checkIsGameOver = function() {
        ...
        isGameOver && GameMgr_1.Game.gameOver(GameMgr_1.OverType.NO_PLACE);
      };
  ...
  OverLayer: [ function(require, module, exports) {
    ...
    var OverLayer = function(_super) {
      ...
      OverLayer.prototype.next = function(step) {
        ...
        this.step >= Step.done && (this.showTotal = true);
  ...
  WelcomeScene: [ function(require, module, exports) {
    ...
    var WelcomeScene = function(_super) {
      ...
      WelcomeScene.prototype.onLoad = function() {
        ...
        this.defaultAnimation ? this.defaultAnimation.once(cc.Animation.EventType.FINISHED, this.animationDone, this) : this.nextStep(LOAD_STEP.ANIMATION);
      ...
      WelcomeScene.prototype.animationDone = function() {
        ...
        this.nextStep(LOAD_STEP.ANIMATION);
      };
      WelcomeScene.prototype.nextStep = function(loadStep) {
        ...
        this.DebugLabel.string += "\n";
        this._step |= loadStep;
        loadStep != LOAD_STEP.ANIMATION && console.log("CUR STEP:" + LOAD_STEP[loadStep] + ", total: " + this._step);
        this.maxPercent = (this._step & (65535 ^ LOAD_STEP.ANIMATION)) / (LOAD_STEP.DONE & (65535 ^ LOAD_STEP.ANIMATION));
        ...
        } else if (loadStep == LOAD_STEP.ANIMATION && this.defaultAnimation) {
          this._step &= 65535 ^ LOAD_STEP.ANIMATION;
